namespace Pizza4Ps.PizzaService.Domain.Constants
{
    public static class BussinessErrorConstants
    {
        ...
        public class WorkingSlotErrorConstant
        {
            ...
            public const string WORKING_SLOT_INVALID = "Không ca làm việc nào trong thời gian này";
        ...
        public class BookingErrorConstant
        {
            ...
            public const string ASSIGNED_TABLE = "Bàn đã được chỉ định";
            public const string INVALID_BOOKING_TIME = "Không thể thay đổi thông tin đặt bàn trước nửa tiếng";
        ...
        public class VoucherErrorConstant
        {
            ...
            public const string VOUCHER_OCCUPIED = "voucher đã được sử dụng";
