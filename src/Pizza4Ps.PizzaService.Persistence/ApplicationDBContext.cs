...
namespace Pizza4Ps.PizzaService.Persistence
{
    public sealed class ApplicationDBContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        ...
        public DbSet<OrderItemDetail> OrderItemDetail { get; set; }
        ...
        public DbSet<VoucherBatch> VoucherTypes { get; set; }
        public DbSet<Voucher> Vouchers { get; set; }
        public DbSet<Zone> Zones { get; set; }
        public DbSet<Day> Days { get; set; }
        public DbSet<Shift> Shifts { get; set; }
        public DbSet<WorkingSlot> WorkingSlots { get; set; }
        public DbSet<WorkingSlotRegister> WorkingSlotRegisters { get; set; }
